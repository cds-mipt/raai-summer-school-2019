...
class ProcessFrame84(gym.ObservationWrapper):
    def __init__(self, env=None):
        ...
        self.observation_space = gym.spaces.Box(low=0, high=255, shape=(300, 300, 1), dtype=np.uint8)
    ...
    def process(frame):
        ...
        resized_screen = cv2.resize(img, (300, 300), interpolation=cv2.INTER_AREA)
        x_t = resized_screen#[18:102, :]
        x_t = np.reshape(x_t, [300, 300])
